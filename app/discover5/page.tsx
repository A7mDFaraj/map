          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              */}
              ...
              {/* About Association Card with Internal Text Animation */}
              <motion.div 
                variants={itemVariants} 
                className="bg-[#0D1322]/85 backdrop-blur-2xl rounded-[2rem] p-6 md:p-8 border border-white/10 hover:border-sky-500/40 shadow-2xl hover:shadow-[0_0_35px_rgba(28,129,172,0.2)] relative overflow-hidden group transition-all duration-500 hover:-translate-y-2"
              >
                <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-sky-500 to-transparent opacity-80 group-hover:opacity-100 transition-opacity" />
                
                <motion.div variants={textContainerVariants} initial="hidden" whileInView="show" viewport={{ once: true }}>
                  <motion.h2 variants={textItemVariants} className="text-xl font-black text-white mb-4 flex items-center gap-2.5 relative z-10">
                  ...
                  <motion.p variants={textItemVariants} className="text-slate-300 leading-relaxed font-normal text-sm md:text-base relative z-10">
                    {assocData.aboutText}
                  </motion.p>
                </motion.div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div 
                  variants={itemVariants} 
                  className="bg-[#0D1322]/85 backdrop-blur-2xl rounded-[2rem] p-6 md:p-8 border border-white/10 hover:border-sky-500/50 shadow-xl hover:shadow-[0_0_35px_rgba(28,129,172,0.2)] relative overflow-hidden group transition-all duration-500 hover:-translate-y-2"
                >
                  <div className="absolute top-0 right-0 w-full h-[2px] bg-gradient-to-l from-[#1C81AC] to-transparent opacity-80" />
                  <motion.div variants={textContainerVariants} initial="hidden" whileInView="show" viewport={{ once: true }}>
                    ...
                    <motion.p variants={textItemVariants} className="text-slate-300 leading-relaxed font-normal text-sm">
                      {assocData.vision}
                    </motion.p>
                  </motion.div>
                </motion.div>
                ...
                <motion.div 
                  variants={itemVariants} 
                  className="bg-[#0D1322]/85 backdrop-blur-2xl rounded-[2rem] p-6 md:p-8 border border-white/10 hover:border-emerald-500/50 shadow-xl hover:shadow-[0_0_35px_rgba(62,185,133,0.2)] relative overflow-hidden group transition-all duration-500 hover:-translate-y-2"
                >
                  <div className="absolute top-0 right-0 w-full h-[2px] bg-gradient-to-l from-[#3EB985] to-transparent opacity-80" />
                  <motion.div variants={textContainerVariants} initial="hidden" whileInView="show" viewport={{ once: true }}>
                    <motion.h3 variants={textItemVariants} className="text-lg font-black text-white mb-3.5 flex items-center gap-2.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <motion.div variants={itemVariants} className="bg-[#0D1322]/85 backdrop-blur-2xl rounded-[2rem] p-6 md:p-8 border border-white/10 hover:border-sky-500/40 shadow-xl hover:shadow-[0_0_30px_rgba(28,129,172,0.15)] transition-all duration-500 hover:-translate-y-2">
                  <motion.div variants={textContainerVariants} initial="hidden" whileInView="show" viewport={{ once: true }}>
                    <motion.h3 variants={textItemVariants} className="text-lg font-black text-white mb-5 flex items-center gap-2.5">
                    ...
                    <ul className="space-y-3.5">
                      {assocData.goals.map((goal, idx) => (
                        <motion.li 
                          key={idx} 
                          variants={textItemVariants}
                          className="flex items-start gap-3 text-slate-300 font-medium text-sm leading-relaxed bg-white/5 p-3.5 rounded-2xl border border-white/5 hover:border-sky-500/30 hover:bg-white/10 transition-all group"
                        >
                          <span className="w-6 h-6 rounded-lg bg-sky-500/15 border border-sky-500/30 text-sky-400 flex items-center justify-center shrink-0 text-xs font-bold mt-0.5 group-hover:scale-110 transition-transform">
                            {idx + 1}
                          </span>
                          <span>{goal}</span>
                        </motion.li>
                    ...
                    <div className="flex flex-col gap-3">
                      {assocData.fields.map((field, idx) => (
                        <motion.div 
                          key={idx} 
                          variants={textItemVariants}
                          className="bg-white/5 hover:bg-white/10 text-slate-200 text-sm font-semibold p-4 rounded-2xl border border-white/10 hover:border-emerald-500/40 flex items-center justify-between group transition-all"
                        >
