        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {stats.map((stat, index) => (
            <motion.div 
              ...
              className="bg-[#12172e]/80 border border-white/5 hover:border-[#1C81AC]/40 rounded-[2rem] p-8 shadow-xl backdrop-blur-xl flex flex-col items-center justify-center text-center group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(28,129,172,0.15)] relative overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-col items-center w-full">
                <div className="w-16 h-16 bg-[#0a0d1d] border border-white/10 rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(28,129,172,0.2)] group-hover:scale-110 group-hover:bg-[#1C81AC]/10 group-hover:border-[#1C81AC]/30 transition-all duration-300">
                  {stat.icon}
                </div>
